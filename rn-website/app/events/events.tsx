...
function EventCard({ event }: { event: Event }) {
  ...
  const isRegistrationOpen = event.registrationLink && event.registrationLink !== "#";

  return (
    <AnimeScrollReveal>
      <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-2xl p-8 hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          ...
          <div className="flex-1">
            ...
            <h3 className="text-3xl font-bold font-pixelify text-white mb-3">
              {event.title}
            </h3>
...
export default function Events() {
  ...
  const robotronicsEvent = events.find((e) => e.id === 1);
  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        {/* Featured Event - Robotronics with 3D Rock Model */}
        {robotronicsEvent && (
              ...
              <AnimeScrollReveal delay={200}>
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-white">
                          {new Date(robotronicsEvent.date).toLocaleDateString("en-US", {
                            month: "long",
                            day: "numeric",
                            year: "numeric",
                          })}
                    ...
                    {robotronicsEvent.location && (
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-semibold text-white">{robotronicsEvent.location}</p>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="pt-8">
                    <button
                      onClick={() => {
                        if (robotronicsEvent.registrationLink) {
                          window.open(robotronicsEvent.registrationLink, "_blank");
                        }
                      }}
          ...
          <section className="max-w-5xl mx-auto">
            <AnimeScrollReveal>
              <div className="text-center mb-16">
                <h2 className="text-3xl font-bold font-pixelify text-white mb-3">
                  More Events
                </h2>
                <p className="text-neutral-400 text-lg">
                  Explore our upcoming workshops, bootcamps, and community events
                </p>
              </div>
            </AnimeScrollReveal>
